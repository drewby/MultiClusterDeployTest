...
#
#       AZ_SP_APP_ID: the app id of a azure service principale
#       AZ_SP_PASSWORD: the SP password
#       AZ_TENANT_ID: the tenant for the SP
#
...
if [[ -n $AZ_SP_APP_ID && -n $AZ_SP_PASSWORD && -n $AZ_TENANT_ID ]]; then
    return 0
fi
